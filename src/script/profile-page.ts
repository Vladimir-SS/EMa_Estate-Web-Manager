import "./shared/page";
//TODO: export, don't run code there
import "./profile-page/avatar-loader";
import Item from "./Item/Item";
import DocumentHandler from "./shared/DocumentHandler";

class ProfileItemsHandler {
  public static itemsElement = document.getElementById("items") as HTMLElement; //Im sure is not null

  public static resizeHandler() {
    if (window.innerWidth <= 1220)
      ProfileItemsHandler.itemsElement.classList.add("chubby-items");
    else ProfileItemsHandler.itemsElement.classList.remove("chubby-items");
  }
