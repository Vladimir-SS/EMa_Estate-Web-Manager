...
class Item {
  ...
  public static createInfoContainer(data: BaseData, iconsElement: HTMLElement) {
    ...
    const infoContainer = createSimpleElement(
      "div",
      "content__box--item__info flex-1"
    );
  ...
  public static createInfoIconsElement(data: IconsData) {
    ...
    const spaceElement = createSimpleElement(
      "div",
      "icon-text icon-text--surface"
    );
    spaceElement.append(createIcon("space"), spaceElementInfo);

    const basicIconsContainer = createSimpleElement(
      "div",
      "content__box--item__info__icons__basic"
    );
    basicIconsContainer.appendChild(spaceElement);

    const aux: [number | undefined, string][] = [
      [bathrooms, "bath"],
      [rooms, "room"],
      [parkingLots, "garage"],
    ];
    ...
    const infoIconsElement = createSimpleElement(
      "div",
      "content__box--item__info__icons"
    );
