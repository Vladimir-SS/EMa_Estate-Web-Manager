...
class ItemInfo {
  ...
  private static airQuality: string[] = [
    "",
    "Foarte bună",
    "Bună",
    "Moderată",
  ...
  public static createFacitilitiesContainer(data: ItemData) {
    const facilitiesContainer = createSimpleElement(
      "div",
      "content__box--property__facilities"
    );
  ...
  public static createBuildingContainer(data: BuildingData) {
    const buildingContainer = createSimpleElement(
      "div",
      "content__box--property__facilities"
    );
  ...
  public static addAditionalInfo(weatherData: WeatherData) {
    ...
    infoElement.innerText =
      "Calitatea aerului: " +
      ItemInfo.airQuality[weatherData.list[0].main.aqi.toString()];
    return infoElement;
  }

  public static create(data: ItemData) {
    const propertyContainer = createSimpleElement(
      "div",
      "content__box content__box--property"
    );
    ...
    propertyContainer.append(
      priceElement,
      ItemInfo.createFacitilitiesContainer(data)
    );
